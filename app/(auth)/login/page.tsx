      ...
      <div className="min-h-screen bg-gray-50 flex flex-col justify-center py-12 sm:px-6 lg:px-8" dir="rtl">
        <div className="sm:mx-auto sm:w-full sm:max-w-md">
          ...
          <p className="mt-2 text-center text-sm text-gray-600">
            أو{" "}
            <Link href="/register" className="font-medium text-[#105D3B] hover:text-[#105D3B]/90">
              أنشئ حساب جديد
            </Link>
          </p>
        </div>
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center">
                  <input
                    ...
                    name="remember-me"
                    type="checkbox"
                    className="h-4 w-4 text-[#105D3B] focus:ring-[#105D3B] border-gray-300 rounded accent-[#105D3B]"
                  />
                ...
                <div className="text-sm">
                  <Link href="#" className="font-medium text-[#105D3B] hover:text-[#105D3B]/90">
                    نسيت كلمة المرور؟
                  </Link>
                </div>
              </div>
